---
sidebar_position: 33
title: A.33. Python Pack Unpack tuple, list, set, dict
sidebar_label: A.33. Pack Unpack ➜ Tuple, List, Set, Dict
---
...
## A.33.1. Unpacking element tuple, list, set
...
## A.33.2. Packing element tuple, list, set
...
## A.33.3. Pemanfaatan teknik unpacking pada argument parameter
...
## A.33.4. Packing-unpacking item dictionary
