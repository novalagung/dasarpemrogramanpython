---
sidebar_position: 50
title: A.50. Python CSV File/Data Format
sidebar_label: A.50. File/Data Format ➜ CSV
---
...
## A.50.1. Implementasi CSV di Python
...
## A.50.4. `csv.writer()` dan `csv.reader()`
