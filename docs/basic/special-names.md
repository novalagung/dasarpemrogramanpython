---
sidebar_position: 31
title: A.31. Python Special Names
sidebar_label: A.31. Special Names
---
...
## A.31.3. Variabel `__all__` & file `__init__.py`
...
## A.31.4. Attribute `__name__` milik class `type`
...
## A.31.5. Attribute `__class__` milik semua class / tipe data
...
## A.31.6. Attribute `__mro__` milik semua class / tipe data
...
## A.31.9. Attribute `__doc__` milik semua class dan fungsi
