    ...
    <div className="navbar__inner">
      ...
      <div className="navbar__items navbar__items--right">
        <div style={{ marginTop: '8px', marginRight: '15px' }}>
          <a className="github-button" href="https://github.com/novalagung/dasarpemrogramanpython" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star novalagung/dasarpemrogramanpython on GitHub">Star</a>
          &nbsp;
